        ...
        {Object.entries(filters.availability).map(([key, value]) => (
          <StyledFormControlLabel
            ...
            control={
              <StyledCheckbox
                checked={value}
                onChange={(e) => handleFilterChange('availability', key, e.target.checked)}
              />
            }
        ...
        {Object.entries(filters.languages).map(([key, value]) => (
          <StyledFormControlLabel
            ...
            control={
              <StyledCheckbox
                checked={value}
                onChange={(e) => handleFilterChange('languages', key, e.target.checked)}
              />
            }
            label={key.charAt(0).toUpperCase() + key.slice(1)}
          />
        ...
        {Object.entries(filters.genres).map(([key, value]) => (
          <StyledFormControlLabel
            ...
            control={
              <StyledCheckbox
                checked={value}
                onChange={(e) => handleFilterChange('genres', key, e.target.checked)}
              />
            }
            label={key.charAt(0).toUpperCase() + key.slice(1)}
          />
